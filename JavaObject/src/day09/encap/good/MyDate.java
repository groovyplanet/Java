...
public class MyDate {
	 ...
	 * setter 
	 * 1.은닉변수에 값을 저장할 메서드
	 * 2. 접근제어자는 public으로 선언하고 , 이름은 set+멤버변수명으로 선언한다.
	 * 
	 */
	
	public void setYear(int year){ //붙어있는 단어 카멜 표기법
		//setter를 사용하면 , 유효성 점증 코드를 넣을수도 있습니다.
		if(year < 1 || year > 2024) {
	...
	public int getMonth() {
		...
		public void setSsn(String ssn) {
			...
			ssn = ssn.replace("-", ""); //원본에 반영하려면 this가 아닌 저장.
