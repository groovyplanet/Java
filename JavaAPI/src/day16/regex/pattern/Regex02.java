...
public class Regex02 {
	...
	public static void main(String[] args) {
		 ...
		 * [a-z] - 영문자
		 * [0-9a-z] - 숫자 영문자
		 * [a-zA-Z] - 모든 영문자 (소대문자 전부)
		 * [a-zA-Z가-힣] - 영문자 한글
		 * [a-zA-Z가-힣]+ - 영문자 한글 하나 이상.
		...
		Pattern p1 =Pattern.compile(phone); //정규 표현식 엔진 생성
		Matcher m1 = p1.matcher(info); // 적용 시킬 문자열 넣음
		
		//find() - 정규 표현식을 찾음
		while(m1.find()) {//찾으면 true, 아니면 false
			System.out.println("문자: "+m1.group()); //일치하는 정규 표현식 찾음
